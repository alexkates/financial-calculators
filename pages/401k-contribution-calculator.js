...
export default function _401kContributionCalculator() {
  ...
  const calculateContributionPercent = (
    annualIncome,
    payCyclesPerYear,
  ...
  useEffect(() => {
    const newContributionPercent = calculateContributionPercent(
      annualIncome,
      payCyclesPerYear,
      annualRetirementAmount
    );
    setContributionPercent(newContributionPercent);
  }, [annualIncome, payCyclesPerYear, annualRetirementAmount]);
  return (
    <div>
      <form>
        ...
        <div className="flex flex-col mb-4">
          <label htmlFor="annualRetirementAmount">
